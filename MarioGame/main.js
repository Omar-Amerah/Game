...
function preload() {
  ...
  this.load.spritesheet("idle", "./assets/Char.png", {frameWidth: 24, frameHeight: 24})
}
...
function create() {
  ...
  this.physics.add.collider(blueDino, platforms);
}
let jumptime = 0
function update() {
  jumptime ++;
  ...
  if (cursors.up.isDown && jumptime > 200) {
    jumptime = 0
    isMoving = true
